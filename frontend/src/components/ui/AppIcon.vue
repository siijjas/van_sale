...
// Curated Lucide-style icon set (inner SVG markup, 24×24 viewBox).
const ICONS: Record<string, string> = {
  ...
  boxes: '<rect width="20" height="5" x="2" y="3" rx="1"/><rect width="20" height="5" x="2" y="10" rx="1"/><rect width="20" height="5" x="2" y="17" rx="1"/>',
